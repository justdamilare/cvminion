          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-dark-light rounded-2xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-3 transition-colors duration-300">Missing Keywords</h4>
                  <div className="flex flex-wrap gap-2">
                    {application.generatedResume.ats_score.missing_keywords.map((keyword: string, index: number) => (
                      <span 
                        key={index}
                        className="px-3 py-1 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 rounded-full text-sm font-medium transition-colors duration-300"
                      >
                        {keyword}
                      </span>
                    ))}
                ...
                <div>
                  <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-3 transition-colors duration-300">Improvement Suggestions</h4>
                  <ul className="space-y-2">
                    {application.generatedResume.ats_score.improvement_suggestions.map((suggestion: string, index: number) => (
                      <li key={index} className="flex items-start gap-2 text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300">
              ...
              {showJSON && (
                <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg transition-colors duration-300">
                  <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-2 transition-colors duration-300">Raw JSON Response</h4>
                  <pre className="bg-white dark:bg-gray-900 p-4 rounded-lg overflow-auto max-h-96 text-sm text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
